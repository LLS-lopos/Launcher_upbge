...
def sauvegarder_config():
    ...
    for dossier in dos_icon.iterdir():
        if dossier.is_file():
            ...
            if dossier.name == "trash-svgrepo-com.svg": config_launcher["icon"]["Trash"] = str(dossier)
            ...
            if dossier.name == "browser-ui-svgrepo-com.svg": config_launcher["icon"]["UX"] = str(dossier)
